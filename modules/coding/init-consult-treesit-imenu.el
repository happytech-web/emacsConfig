...
(defconst my/treesit-imenu-tree-settings-alist
  '((python-ts-mode
     . ((nil "\\`\\(?:class\\|function\\)_definition\\'" nil nil)))
    (c-ts-mode
     . ((nil "\\`\\(?:function_definition\\|struct_specifier\\|union_specifier\\|enum_specifier\\|type_definition\\|preproc_\\(?:def\\|function_def\\)\\)\\'" nil nil)))
    (c++-ts-mode
     . ((nil "\\`\\(?:class_specifier\\|struct_specifier\\|function_definition\\|enum_specifier\\|type_definition\\|namespace_definition\\|preproc_\\(?:def\\|function_def\\)\\)\\'" nil nil)))
    (rust-ts-mode
     . ((nil "\\`\\(?:function_item\\|struct_item\\|enum_item\\|trait_item\\|impl_item\\|type_item\\|const_item\\|static_item\\|macro_definition\\)\\'" nil nil)))
    (bash-ts-mode
     . ((nil "\\`\\(?:function_definition\\|variable_assignment\\)\\'" nil nil)))
    (yaml-ts-mode
     . ((nil "\\`block_mapping_pair\\'" nil my/yaml-ts-key-node-name)))
    (markdown-ts-mode
     . ((nil "\\`\\(?:atx\\|setext\\)_heading\\'" nil nil)
        (nil "\\`fenced_code_block\\'" nil nil))))
  "Tree-structure tree-sitter imenu settings per major mode (for imenu-list).")
...
(defun my/treesit-imenu-settings-for-current-mode ()
  "Return categorized tree-sitter imenu settings for current major mode."
  (cdr (assq major-mode my/treesit-imenu-settings-alist)))

(defun my/treesit-imenu-tree-settings-for-current-mode ()
  "Return tree-structure tree-sitter imenu settings for current major mode."
  (cdr (assq major-mode my/treesit-imenu-tree-settings-alist)))
...
(defun my/treesit-consult-imenu-setup ()
  ...
  (when (and (fboundp 'treesit-simple-imenu)
    ...
    (let* ((tree-settings (my/treesit-imenu-tree-settings-for-current-mode))
           (cat-settings (my/treesit-imenu-settings-for-current-mode))
           (cat (if my/treesit-imenu-prefer-custom-settings
                    (or cat-settings tree-settings)
                  (or tree-settings cat-settings))))
      (when tree-settings
        (setq-local treesit-simple-imenu-settings tree-settings)
...
(defun my/consult-imenu--treesit-settings (fn &rest args)
  "Temporarily bind categorized treesit settings for `consult-imenu'."
  (let ((treesit-simple-imenu-settings
         (or (my/treesit-imenu-settings-for-current-mode)
